...
namespace Kamgam.SettingsGenerator
{
    public partial class CreateSettingUGUIWindow : EditorWindow
    {
        ...
        private void onResolverEntryIndexChanged(int oldIndex, int newIndex)
        {
            ...
            {
                // Delay because onHierarchyChanged is fired asynchronously.
        ...
        void updateSelectedUIContainer(GameObject go)
        {
            ...
            else if (_uiContainer == null && go == null)
            {
                ...
                var resolver = GameObject.FindObjectOfType<SettingResolver>(includeInactive: false);
                ...
                {
                    // Try canvas
                    var canvas = GameObject.FindObjectOfType<Canvas>(includeInactive: true);
                    if (canvas != null)
                    {
        ...
        VisualElement makeItem()
        {
            ...
            nameLbl.tooltip = "Shows the ID of the setting.\n" +
                              ...
                              "HINT: Double clicking will open the details of this setting UI.";
            ...
            editBtn.tooltip = "Opens the settings details for editing.\n\n" +
                              "HINT: You can also open the details via double clicking on the setting name/id.";
