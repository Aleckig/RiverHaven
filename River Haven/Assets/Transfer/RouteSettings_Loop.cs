...
public class RouteSettings_Loop : MonoBehaviour
{
    [SerializeField] private float rotationSpeed = 5;
    [SerializeField] private int RouteId = 0;
    [SerializeField] private float loopDelayTimeSeconds = 45f;
    [SerializeField] private Transform resetPoint;
    private List<RouteAction> Actions;
    private NPCAnimator animator;
    private NavMeshAgent navMeshAgent;
    public RouteManager_Loop routeManager;
    ...
    public void Start()
    {
        ...
        StartCoroutine(LoopRoute());
    }

    private IEnumerator LoopRoute()
    {
        while (true)
        {
            // Check if the NPC is still active and enabled before continuing
            ...
            // Wait for the specified delay time before looping again
            yield return new WaitForSeconds(loopDelayTimeSeconds);

            FollowPathWithTp(RouteId);
        }
    }
